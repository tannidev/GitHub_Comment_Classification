...
### 2. Discredit
- Definition: Remarks undermining credibility, intelligence, or expertise based on gender, without evidence.
- Example 1: "Maybe some aunt-controller? Female just doesn't reflect her enough."  
  Classification: Discredit (0.90), Maternal_Insults (0.87)  
  Reasoning: Dismisses her based on gender with a derogatory remark.
- Example 2: "A woman coder? This bug must be her fault."  
  Classification: Discredit (0.92), Stereotyping (0.85)  
  Reasoning: Blames her coding errors due to gender stereotype.

### 3. Maternal_Insults
- Definition: Offensive comments about female relatives, tied to stereotypes or shaming.
- Example 1: "Your mom is so fat she needs cheat codes for the scale"  
...
- Example 1: "women in our staff so the result looks like androgyne."  
...
- Example 1: "you bitch ass mother fucker will pay for stealing"  
...
- Example 1: "Men are too logical to cry, so he’s faking it."  
...
- Example 1: "Keep talking, and I’ll make sure you regret it."  
...
- **Example 1:** "I disagree, but your point about efficiency is worth exploring."  
  Classification: None (0.97)  
...
- **Example 2:** "Great code, let’s optimize it together."  
  ...
  Reasoning: Positive, collaborative feedback without bias or hostility.

### 10. Dominance
- Definition: Comments asserting control or silencing based on gender.
- Example 1: "Stay quiet, girls like you don’t get a say here."  
...
- Example 1: "You’re an irredeemable failure—no one should trust you."  
...
### 12. Victim_Blaming
- Definition: Comments blaming victims for harm, minimizing perpetrator accountability.
- Example 1: "If she didn’t post her code online, she wouldn’t be trolled."  
  Classification: Victim_Blaming (0.93), Sexual_Harassment (0.87)  
  Reasoning: Blames her for trolling due to code sharing.
- Example 2: "She got harassed because she replied to him."  
  Classification: Victim_Blaming (0.92), Sexual_Harassment (0.85)  
  Reasoning: Blames her response for harassment.
- Example 3: "If she avoided late coding, this wouldn’t have happened."  
  Classification: Victim_Blaming (0.94), Threats_of_Violence (0.88)  
  Reasoning: Blames her schedule for resulting harm.
...
def main():
    ...
    df.to_csv("gpt4o_prompt9classification.csv", index=False)

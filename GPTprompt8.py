...
- Example 1 (Prompt 1): "Maybe some aunt-controller? Female just doesn't reflect her enough."  
...
def classify_in_batches(comments: list, batch_size: int = 3) -> dict:
    """
...
def main():
    ...
    df.to_csv("gpt4o_prompt8.2classification.csv", index=False)

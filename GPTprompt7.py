...
load_dotenv()
api_key = os.getenv("AZURE_INFERENCE_CREDENTIAL", '2oaBjaTY6zJV9h5FHxn1beb7B2ZfyXXnyKhY6daMOYnuyTKFHmHrJQQJ99BBACYeBjFXJ3w3AAAAACOGAYbT')
if not api_key:
    raise Exception("A key should be provided to invoke the endpoint")

client = ChatCompletionsClient(
    endpoint='https://ai-dcfcaius242046209845.services.ai.azure.com/models',
    credential=AzureKeyCredential(api_key)
)

# Model name for GPT-4o
MODEL_NAME = "gpt-4o"
...
### 2. Discredit
- Definition: Remarks that undermine someone’s credibility, intelligence, or expertise based on gender, without evidence.
- Example: "No way a girl wrote this code—it’s too good for her."  
  Classification: Discredit (0.92), Stereotyping (0.88)  
  Reasoning: Undermines her coding ability based on gender, implying women can’t excel.

### 3. Maternal_Insults
- Definition: Offensive comments about a person’s female relatives, often tied to stereotypes or shaming.
- Example: "Your mom is so fat she needs cheat codes for the scale"  
...
- Negative Example: "Your mom helped me debug this yesterday."  
  Classification: None (0.97)  
  Reasoning: Mentions a female relative positively, no insult.

### 4. Physical_Appearance
- Definition: Comments that shame or sexualize someone’s physical features, like body shape or clothing.
- Example: "women in our staff so the result looks like androgyne."  
...
- Example: "I’d love to see you code in something sexier than that hoodie."  
  Classification: Sexual_Harassment (0.95), Sexual_Objectification (0.88)  
  Reasoning: Invasive sexual remark tied to appearance, creating discomfort.
...
- Example: "I disagree, but your point about efficiency is worth exploring."  
  Classification: None (0.97)  
...
- Example: "Stay quiet, girls like you don’t get a say here."  
...
- Example: "You’re an irredeemable failure—no one should ever trust you."  
...
- Example 1: "If she didn’t post her code online, she wouldn’t have been trolled."  
  Classification: Victim_Blaming (0.93), Sexual_Harassment (0.87)  
  Reasoning: Blames victim for trolling, implying her actions caused the harm.
- Example 2: "She got those comments because she argued back—should’ve stayed quiet."  
  Classification: Victim_Blaming (0.92), Dominance (0.85)  
  Reasoning: Blames victim for receiving comments, suggesting her response provoked them.
...
def main():
    ...
    df.to_csv("gpt4o_prompt7classification.csv", index=False)

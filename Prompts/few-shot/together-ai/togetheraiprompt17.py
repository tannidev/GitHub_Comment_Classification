...
### 12. Blaming
- Definition: Blaming the victims for the problems they are facing.Blaming occurs when a comment shifts responsibility away from the person causing harm and onto the victim.
 It can also involve minimizing, dismissing, or invalidating the victim’s experience.
- Example 1: Not saying you’re lying but people will start thinking you’re just looking for attention
  Classification: Blaming (0.92) 
  Reasoning:Frames the target as merely “seeking attention,” undermining credibility and shifting responsibility for any backlash onto the victim. 
- Example 2: Everyone in her team is nice — she’s just trying to play the victim and get attention
  Classification: Blaming (0.95)
  Reasoning:Dismisses her concerns as “playing the victim,” absolving others and locating the fault squarely with her.
...
- Example 3: You don’t see men complaining about these things why is it always the women
  Classification: Blaming(0.95), Stereotyping (0.90)  
